<?php  
	include '../data/config/koneksi.php';
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<?php if(isset($_GET['excel'])){ ?>
				...
				<?php } ?>
			<td>
				<h4 style="margin-top: 10px;margin-left: -10px;">PERUSAHAAN LISTRIK NEGARA</h4>
				<h1 style="margin-top: -20px;margin-left: -10px;" >PT. PLN PERSERO</h1>
				<h5 style="margin-top: -20px;margin-left: -10px;">JL. Lingkar Duri Kosambi, Cengkareng, Jakarta Barat 11750</h5>
			</td>
		</tr>
