...
<?php  
	include '../data/config/koneksi.php';//untuk koneksi ke database
	include '../data/library/fungsi.php';//untuk memasukan library
...
<body style="background:url('../data/images/bg_agen.jpg');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../data/images/logo_setroom.png" alt="logo" class="logo" width="90px">
							</div>
							...
							<div style="margin-left: 110px; font-size: 200%;">
								<strong>FORM LOGIN AGEN PLN</strong>
							</div>
						</div>
						<!-- end judul -->
							...
							<div class="col-md-12">
								<form method="post">
									...
									<div class="form-group" align="right">
										<a href="../index.php"><label>Kembali ke MENU</label></a>
									</div>
								</form>
							</div>
						</div>
						...
						<div class="panel-footer">
							<center>&copy;2023 - Ahmad Salim Maula</center>
						</div>
						<!-- end footer -->
					</div>
				</div>
